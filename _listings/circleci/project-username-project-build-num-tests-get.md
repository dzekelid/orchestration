  ...
  /project/{username}/{project}/{build_num}/tests:
    get:
      ...
      description: |-
        ...
        Note: [Learn how to set up your builds to collect test metadata](https://circleci
      operationId: provides-test-metadata-for-a-buildnote-learn-how-to-set-up-your-builds-to-collect-test-metadatahttps
      responses:
        200:
          description: OK
      tags:
